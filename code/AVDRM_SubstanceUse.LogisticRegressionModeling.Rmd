...
```{r}
# Read in the data
data <- read.csv("original_data/Andrew_stats_MS.csv")
...
fit_and_store_model <- function(formula_str, data) {
...
I'm not sure why marijuana * poly_substance has such a high odds ratio but I'll look into it - however, this isn't the significant term (marijuana is) so it should not matter.
